...
#     images, labels = data_loader.get_data(dataset_dir="C:/Users/CdC/Desktop/studium/programmi/metodi per IA", kind='train')
#     print(images.shape, labels.shape)
#     print(np.unique(labels, return_counts=True))
#     print("\n")
#     images, labels = data_loader.get_data(dataset_dir="C:/Users/CdC/Desktop/studium/programmi/metodi per IA", kind='test')
#     print(images.shape, labels.shape)
#     print(np.unique(labels, return_counts=True))